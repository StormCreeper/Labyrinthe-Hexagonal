...
import impls.MinDistanceImpl;
import impls.ProcessedVertexesImpl;
import impls.ShortestPathsImpl;
...
public class Dijkstra {
	 ...
	 */
	private static ShortestPaths dijkstra(Graph graph, Vertex startVertex, Vertex endVertex, ProcessedVertexes processedVertexes, MinDistance minDistance, Distance distance, ShortestPaths shortestPaths) {
	...
	public static ShortestPaths dijkstra(Graph graph, Vertex startVertex, Vertex endVertex, Distance distance) {
		ProcessedVertexes pv = new ProcessedVertexesImpl();
		MinDistance md = new MinDistanceImpl();
		ShortestPaths sp = new ShortestPathsImpl();
		
		return dijkstra(graph, startVertex, endVertex, pv, md, distance, sp);
	}
